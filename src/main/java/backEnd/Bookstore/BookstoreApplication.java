...
public class BookstoreApplication {
	...
	return (args) -> {
		...
		repository.save(new Book("Animal Farm", "George Orwell", 1945, "2212343-51", 14.95, catrepository.findByName("Satire").get(0)));
		...
		AppUser user1 = new AppUser("user", "$2a$10$frMxi0uQMwPkoCW8PB0f.e9vRXvASV.D/cdzFjHbp3NBTkl235R0q", "user@user.com", "USER");
		AppUser user2 = new AppUser("admin", "$2a$10$ks3hdKMUX6LZzgBWxte27.IVYiboBl47B3ghUaJi7g9SWmiqe2EUS", "admin@admin.com", "ADMIN");
